...
This is a small Python package designed to download then tabulate your hourly energy usage data from the BGE website, and then do a little analysis with it to understand and predict household energy usage. 

I made this code as a little personal project, because we had done some energy efficiency upgrades to our house, and I wanted to understand how much of an impact these were having on our bills. The BGE (Baltimore Gas and Electric) account website provides very useful hour-by-hour usage plots for electricity and gas. Cool! However, they don't provide a way to download that usage data in bulk.
...
I made this code for personal use. Please do not use it to DoS the BGE website, or do anything else silly/nefarious. I appreciate BGE providing the hourly usage data they do, enough though I *really* wish they would allow us to download it in bulk.
